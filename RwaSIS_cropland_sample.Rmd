...
The following chunk downloads the needed and publicly available geotiffs and shape file that define the RwaSIS project's ROI (i.e, cropland && distance to buildings < 0.5 km).
...
This is the output data frame `samp` of the proposed sampling locations with their corresponding long/lat coordinates, which can also be sorted by various administrative units and/or `GID`.
...
Note that follow-up on the ground will be needed to actually install any actual surveys and/or field trials. This will require negogiations with farmers, government, private sector and civil society representatives at the proposed locations and perhaps also a pre-survey of the prevailing cropping systems and soil condition for such surveys or experiments. We will provide additional guidance about the relevant field procedures and potential experimental setups ... stay tuned.
