...
Note that follow-up on the ground will be needed to actually install any actual field trials. This will require negogiations with farmers, government, private sector and civil society representatives at the proposed locations and also a pre-survey of the prevailing cropping systems and soil condition for such survey. We will provide additional guidance about the relevant field procedures and potential experimental setups ... stay tuned.
