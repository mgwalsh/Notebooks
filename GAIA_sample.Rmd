...
You can also generate a zoomable map of the proposed trial locations with the `leaflet` package. This shows the proposed distribution of trial sites and also help with navigation and operational planning on the ground.
