...
Note that follow-up on the ground will be needed to actually install any actual field trials. This will require negogiations with farmers and government representatives at the proposed locations and also a pre-survey of the prevailing soil conditions and cropping systems for such trials. We will provide seperate guidance about the relevant field procedures.
