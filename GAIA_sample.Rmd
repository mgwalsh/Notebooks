...
You can also generate a zoomable map of the proposed trial locations with the `leaflet` package. This shows the proposed distribution of trial sites, which will also help with navigation and operational planning on the ground.

```{r}
# Sampling map widget -----------------------------------------------------
# render map
w <- leaflet() %>%
  setView(lng = mean(samp$lon), lat = mean(samp$lat), zoom = 3) %>%
...
Note that follow-up on the ground will be needed to actually install any actual field trials. This will require negogiations with farmers, government, private sector and civil society representatives at the proposed locations and also a pre-survey of the prevailing soil conditions and cropping systems for such trials. We will provide additional guidance about the relevant field procedures.
